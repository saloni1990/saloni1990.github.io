...
<p>Another thing I found quite interesting was that IDs have special browser functionality. ID's come with the 'hash value'. So, for example, if i were to have a URL like www.sallearnstocode.co.uk/#comments and I had an ID labelled '#comments', when I click on that link the page will automatically scroll to that part of the page.</p>
</body>
</html>
